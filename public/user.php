...
if (isset($_GET['error'])) {
    $errorMap = [
        ...
        'db-error'       => "Erreur de connexion au serveur."
    ];
...
<main>
    <section class="mt-20 flex flex-col items-center text-center max-w-7xl mx-auto mb-10 md:mb-16 px-4">
        ...
        <div class="w-full mb-6">
            <h1 class="text-2xl md:text-5xl lg:text-[54px] font-bold leading-tight wrapbreak-words">
                <span class="text-[#33658A]">Qui</span><span class="text-[#FCC822]">Zena</span><span class="text-[#000000]"> : Le plaisir de giocare tra amici</span>
            </h1>
    ...
    <section class="w-full flex justify-center px-2 md:px-4 pb-20 relative">
        <div class="w-full max-w-[98%] md:max-w-3xl bg-[#FCC822]/5 border-[1.5px] md:border-2 border-black rounded-[20px] md:rounded-[25px] p-6 md:p-16 shadow-sm backdrop-blur-sm relative z-10">
            ...
            <form action="../process/login_process.php" method="POST" class="flex flex-col items-center w-full">
                ...
                <div class="flex flex-col md:flex-row gap-4 md:gap-6 w-full max-w-lg mb-8 md:mb-12">
                    <button type="submit" class="w-full md:flex-1 bg-[#FCC822] text-black font-bold py-3 md:py-4 rounded-full border border-black transition-all active:scale-95 shadow-[0_4px_0_#000] active:shadow-none active:translate-y-1">
                        Me reconnecter
                    </button>
                    <button type="submit" class="w-full md:flex-1 bg-[#FCC822]/30 text-black font-bold py-3 md:py-4 rounded-full border border-black transition-all active:scale-95 shadow-[0_4px_0_#000] active:shadow-none active:translate-y-1">
                        M'inscrire
                    </button>
                </div>
            </form>
        ...
        <div class="absolute -bottom-36 left-4 md:right-20 lg:right-40 z-10 hidden sm:block pointer-events-none">
